...
<div class="center">Esperanto • [English](/en/adv360/)</div>
...
Advantage kaj [Kinesis Advantage360
Professional](https://kinesis-ergo.com/keyboards/advantage360/). Mi antaŭ longe
skribis pri la [Kinesis Advantage](/en/advantage/) kaj mi laŭdis ĝin.

Kiam mi malkovris, ke Kinesis enkondukos novan linion de Advantage-klavarojn kun
la kapablo por remapi la klavojn per programaro, kaj ĝi havas sendratan
konektecon, mi fariĝis sciema. Mi kontaktis la Kinesis-provizanton el japano, la
saman ulon kiun mi prenis mian originalan Advantage-klavaron. Mi ricevis
...
ĝi, lernante ion kion mi povas havi. Mi lernis, ke ĝi uzas la [ZMK
mikropragramon](https://zmk.dev). Mi lernis, ke por redefini la klavojn, oni uzu
...
lasante ĝin munti la mikroprogramojn por oni.
...
Kompreneble, mi ne estis feliĉa per la implicita aranĝo kaj mi ŝanĝis ĝin. Unue,
mi devis iri al 
la
[Adv360-Pro-ZMK](https://github.com/KinesisCorporation/Adv360-Pro-ZMK)-deponejo,
kaj mi forkis ĝin. Sekve, estas por ebligi Actions por ke ĉiu foje oni puŝan
ŝanĝojn al la deponejo, kreiĝu novaj mikroprogramoj.

Do, tio kion mi farus estas fari ŝanĝojn en la ttt-apo, konservi la ŝanĝojn,
tiam atendu por la kreado de la mikroprogramoj. La rezultantaj dosieroj estas
`left.uf2` kaj `right.uf2`, por la maldekstra kaj dekstraj flankoj, respektive.
...
<kbd>End</kbd> klavoj. Mi ĉiam uzas la lastan metodon.
...
malkovris, ke estas pli rekta metodo.  La [oficiala ZMK
dokumentado](https://zmk.dev/docs) estas tre helpema, tie.
...
por Device Tree Structrure Includes (angle), kiu estas tipo de inklud-dosiero
por DTS-agordo.
...
Por la ĉefa nivelo, la `adv360.keymap`-dosiero, ĉe la maldekstra parto de la
klavaro estas
...
<a name="laborfluo">Laborfluo</a>
---------------------------------

Kiam ajn mi devas ĝisdatigi la agordon, mi ŝanĝus la antaŭmenciitajn dosierojn,
kaj puŝi la ŝanĝojn al GitHub, tiam mi atendas la mikroprogramojn pos esti
muntitaj, tiam mi fulmos ilin al la klavaro.


<a name="finrimarkoj">Finrimarkoj</a>
-------------------------------------

La Kinesis Advantage360 Professional-klavaro estas bonega investaĵo se mi uzas
